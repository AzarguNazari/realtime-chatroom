...
function showMessage(userID, content) {

    var userIdInfo = $("<span>").addClass("direct-chat-name pull-left").text(userID);
    var directChatText = $("<div>").addClass("direct-chat-text").text(content);

    var directChatInfo = $("<div>").addClass("direct-chat-info clearfix");
    directChatInfo.append(userIdInfo);
    directChatInfo.append(directChatText);

    var chatMessageBox = $("<div>").addClass("direct-chat-msg");
    chatMessageBox.append(directChatInfo);

    $("#message-box").append(chatMessageBox);
}
